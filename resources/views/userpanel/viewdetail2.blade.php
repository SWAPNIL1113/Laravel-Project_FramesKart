                    ...
                    <div class="col-md-6">
                        <div class="product p-4">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center"><a href="/user_products"> <i class="fa fa-long-arrow-left"></i> <span class="ml-1">Back</span> </a></div> 
                            </div>
                        ...
                        <div class="d-flex flex-column mt-4">
                            <div class="cart mt-4 align-items-center"> <a href="/adminindex"><button class="btn btn-danger text-uppercase mr-2 px-4">Add to cart</button></a>
                        </div>
